      ...
      <div className="bg-transparent container_carousel2">
        <OwlCarousel className="owl-theme" {...options}>
          <div className="items2 text-center">
            <img className="carousel2__img" src={Background3} alt="img 1" />
          </div>
          <div className="items2 text-center">
            <img className="carousel2__img" src={Background2} alt="img 2" />
          </div>
          <div className="items2 text-center">
            <img className="carousel2__img" src={Background1} alt="img 3" />
          </div>
          <div className="items2 text-center">
            <img className="carousel2__img" src={Background4} alt="img 4" />
          </div>
        </OwlCarousel>
      </div>
      <br />
